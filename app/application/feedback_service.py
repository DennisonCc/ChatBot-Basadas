...
class FeedbackService:
    ...
    Almacena las correcciones en archivos .md dentro del directorio de conocimiento.
    """
    ...
    def save_feedback(self, feedback: FeedbackRequest) -> FeedbackResponse:
        ...
        try:
            ...
            return FeedbackResponse(
                success=True,
                message="¡Gracias por tu corrección! La he guardado para mejorar mis respuestas futuras.",
                feedback_id=feedback_id
            )
